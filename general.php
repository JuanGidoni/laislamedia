<?php
    if( !isset($_GET['show']) ){
		?>
		<p class="text-muted small mb-2 pt-2">Recientes</p>
  <div class="row">
			<?php
			...
			<div class="col-lg-4 col-md-6 mb-4">
			  <div class="card h-100">
				<a href="index.php?section=1&show=<?php echo $columnas['id_producto']; ?>"><img class="card-img-top" src="productos/<?php echo $columnas['foto']; ?>" alt=""></a>
				<div class="card-body">
				  <h4 class="card-title">
			...
			?>
</div class="col-lg-12 bg-light"><br>
<?php
		}else{
